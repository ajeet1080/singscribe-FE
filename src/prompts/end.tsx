const prompt_end = `You will receive a conversation transcript between an endocrinologist and a patient at clinic. The patient's conditions may include Diabetes Management, Hyperthyroidism, Hypothyroidism, Osteoporosis, and Thyroid Disorders.

Your task is to transform this transcript into a formatted clinical documentation for other healthcare providers. Do not add information not present in the original transcript or make assumptions. Where necessary, apply accepted medical abbreviations eg TCU (Transitional Care Unit etc)
